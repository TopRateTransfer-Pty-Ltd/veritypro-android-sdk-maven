...
fun EddCompleteScreen(
    ...
    Column(
        ...
        Text(
            text = "Your EDD documents have been submitted for compliance review. You will be notified once the review is complete.",
        ...
        Row(
            ...
            Text(
                text = "AUSTRAC compliance review in progress",
                fontSize = 12.sp,
                fontWeight = FontWeight.W500,
